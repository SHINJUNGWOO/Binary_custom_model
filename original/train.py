...
parser.add_argument('--data',type=str, default='../img_data/imagenet', metavar='DIR', help='path to dataset')
...
def main():
    ...
    model_student = reactnet(CLASSES)
   ...
   # traindir = os.path.join(args.data, 'train')
    ...
    #
    #
    # cifar100_train = datasets.CIFAR100("../data", train=True, download=True,
    ...
    #                                        ),
    #                                    ]))
    # cifar100_eval = datasets.CIFAR100("../data", train=False, download=False,
    #                                   transform=transforms.Compose([
    #                                       transforms.ToTensor(),
    #                                       transforms.Normalize(
    #                                           mean=[0.5071, 0.4865, 0.4409],
    ...
    # val_loader = DataLoader(cifar100_eval, batch_size=64, shuffle=True, )
