...
from custom_model_2 import Basicblock, Aresblock, Aresblock1_1, Aresblock1_2,Aresblock1_3, Aresblock1_4
...
class custom_react(nn.Module):    
    def __init__(self, stage_channel = (32,64,128,128,256,256,512,512,512,512,512,512,1024,1024),num_class = 100):
        ...
        stage_channel = (32,64,64,128,128,256,256,512,512)
        ...
        for i,out_channel in enumerate(stage_channel):
            ...
            #    self.feature.append(Aresblock(stage_channel[i - 1], out_channel, 2))
                ...
                self.feature.append(Aresblock1_4(stage_channel[i - 1], out_channel, stride=2))
            else:
                self.feature.append(Aresblock1_4(stage_channel[i - 1], out_channel, stride=1))
