...
class Aresblock1_6(nn.Module):
    def __init__(self,in_channel,out_channel,binarized = False,stride = 1,groups = 2):
        ...
        self.Grouped3x3 = GroupedConv(in_channel, out_channel // 2, stride = self.stride, groups=groups, binarized = binarized) #\
                          #if binarized else \
        ...
        self.Grouped1x1 = GroupedConv(out_channel, out_channel // 2, stride = 1, kernel_size=3, padding=1, groups=groups, binarized = binarized) #\
                          #if binarized else \
